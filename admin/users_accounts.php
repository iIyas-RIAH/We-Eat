...
if(isset($_GET['deleteAll'])){
   $delete_users = $conn->prepare("DELETE FROM `users`");
...
<section class="accounts">
   ...
   <div class="box-container">
      <span>
         ...
         <a href="users_accounts.php?deleteAll" onclick="return confirm('delete all users?');" class="delete-btn">delete all users</a>
      </span>
   </div>
